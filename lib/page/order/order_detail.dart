  ...
  void initState() {
    ...
    switch (arguments["orderStateIndex"]) {
      case 0:
        ...
        return;
      case 1:
        titleUI.value = {"title": "出荷待", "img": "order_detail_receive@3x.png"};
        return;
      case 2:
        titleUI.value = {"title": "受取済", "img": "order_detail_mail@3x.png"};
        return;
      default:
        titleUI.value = {"title": "完了", "img": "order_detail_finish@3x.png"};
        return;
    }
  }
                ...
                Column(
                  ...
                  children: [
                    customWidget.setTextOverflow("15880",
                            ...
                            fontSize: 14,
                            color: CustomColor.black_3),
                    customWidget.setTextOverflow("C295",
                        fontSize: 14,
                        color: CustomColor.black_3,
                  ...
                  children: [
                    ...
                    customWidget.setTable(color: Colors.transparent, [
                      TableRow(children: [
                        ...
                        customWidget.setTextOverflow("A1753405342867",
                      ...
                      TableRow(children: [
                        customWidget.setTextOverflow("注文時間",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("2025-07-25 01:02:22",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
                      ...
                      if (!isStorePickup)
                        TableRow(children: [
                          customWidget.setTextOverflow("配送先",
                              ...
                              fontSize: 12,
                              color: CustomColor.gray_6),
                          customWidget.setTextOverflow("柬京都千代田区千代田比",
                              padding: const EdgeInsets.all(5),
                              fontSize: 12,
                              color: CustomColor.black_3)
                        ]),
                      TableRow(children: [
                        customWidget.setTextOverflow("予约时间",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("2025-07-2816:00-18:00",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
                      TableRow(children: [
                        customWidget.setTextOverflow("支付状况",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("支払済",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
                ...
                Column(
                  ...
                  children: [
                    ...
                    customWidget.setTable(color: Colors.transparent, [
                      ...
                      TableRow(children: [
                        customWidget.setTextOverflow("黑騎士バン",
                            margin: const EdgeInsets.symmetric(vertical: 5),
                            fontSize: 12,
                            color: CustomColor.black_3),
                        customWidget.setTextOverflow("1",
                            margin: const EdgeInsets.symmetric(vertical: 5),
                            fontSize: 12,
                            color: CustomColor.black_3),
                        customWidget.setTextOverflow("￥ 300",
                            margin: const EdgeInsets.symmetric(vertical: 5),
                            fontSize: 12,
                            color: CustomColor.black_3),
                      ]),
                      TableRow(children: [
                        customWidget.setTextOverflow("コ-ヒ-クリ-ムチ-ズバン",
                            margin: const EdgeInsets.symmetric(vertical: 5),
                            fontSize: 12,
                            color: CustomColor.black_3),
                        customWidget.setTextOverflow("1",
                      ...
                      TableRow(children: [
                        customWidget.setTextOverflow("ココナッツバン",
                            margin: const EdgeInsets.symmetric(vertical: 5),
                            fontSize: 12,
                            color: CustomColor.black_3),
                        customWidget.setTextOverflow("1",
                    ...
                    customWidget.setTable(color: Colors.transparent, [
                      TableRow(children: [
                        customWidget.setTextOverflow("合計金额",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("￥ 890",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                      ...
                      TableRow(children: [
                        customWidget.setTextOverflow("配送料",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("￥ 0",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
                      ...
                      TableRow(children: [
                        customWidget.setTextOverflow("ポイント支払 ",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("0pt",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
                      TableRow(children: [
                        customWidget.setTextOverflow("合計消費税",
                            ...
                            fontSize: 12,
                            color: CustomColor.gray_6),
                        customWidget.setTextOverflow("￥ 65",
                            padding: const EdgeInsets.all(5),
                            fontSize: 12,
                            color: CustomColor.black_3)
                      ]),
